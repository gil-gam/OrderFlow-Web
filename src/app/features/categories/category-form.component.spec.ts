...
describe('CategoryFormComponent', () => {
  ...
  const mockCategory = { id: '1', name: 'Electronics', description: 'Electronic items', createdAt: baseDate, updatedAt: baseDate };

  const createComponent = (isEditMode = false) => {
  ...
  it('should create in creation mode', () => { createComponent(false); expect(component).toBeTruthy(); });
  ...
  it('should navigate to /categories on success', () => {
    createComponent(false);
    categoryServiceMock.create.and.returnValue(of({ ...mockCategory, id: '3' }));
    component.form.patchValue({ name: 'Books', description: 'Reading' });
    component.onSubmit();
